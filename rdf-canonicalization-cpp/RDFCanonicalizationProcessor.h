#ifndef RDFCANON_CPP_LIBRARY_RDFCANONICALIZATIONPROCESSOR_H
#define RDFCANON_CPP_LIBRARY_RDFCANONICALIZATIONPROCESSOR_H
...
#endif //RDFCANON_CPP_LIBRARY_RDFCANONICALIZATIONPROCESSOR_H
